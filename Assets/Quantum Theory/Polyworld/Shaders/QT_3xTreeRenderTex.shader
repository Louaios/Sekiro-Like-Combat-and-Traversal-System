...
fixed4 frag (v2f i) : SV_Target
{
	...
	ApplyTreeLighting(light, albedo, 0, 0, _TerrainTreeLightColors[0], i.params1);
	ApplyTreeLighting(light, albedo, 0, 0, _TerrainTreeLightColors[1], i.params2);
	ApplyTreeLighting(light, albedo, 0, 0, _TerrainTreeLightColors[2], i.params3);
